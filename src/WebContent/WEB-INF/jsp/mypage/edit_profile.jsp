...
<body>
			...
			<div class = "form">
				<form id="user_profile_from" method="POST" name="uprform" action="EditProfileServlet">
					...
					<tr>
						<td>
							生年月日
							<input type="date" name ="birthday" id="edityear" onchange="inputChange();">
							<!--
 ...
 -->
					...
					<tr>
						<td>
							性別<select id="nickname" class = "form_user9" name="gender" value="${user.gender}" onchange="inputChange();">
					...
					<tr>
						<td>
							出産予定日<input size="30" type="date" id="due_date" class = "form_user10" name="due_date" value="${user.due_date}" required placeholder="出産予定日" onchange="inputChange();">※必須<br>
						</td>
					</tr>
					<tr>
						<td>
